$(document).ready(function(){
    ...
    var question1 = new Verses("I had a ghetto boy bop, a Jay-Z boycott <br> Cause he said that he never prayed to God, he prayed to Gotti <br> I\'m thinking \"golly, God, guard me from the ungodly\" <br> But by my 30th watching of \"Streets is Watching\" <br> I was back to giving props again and that was bothering",'answer4', "Lupe Fiasco","Lupe is always on his game","Hurt Me Soul","Food & Liquor");
    
    var question2 = new Verses("Some come in the form of codependence <br> A lot of times only end up being codefendants <br> Ten bucks say they tell for a lower sentence <br> And leave you up under the jail, begging for a penance <br> It don't make no sense, what happened to the loyalty? <br> Honor amongst crooks, trust amongst royalty <br> I'd rather go out in a blaze, than give 'em the glory <br> (How many of us have...) a similar story",'answer1', "MF Doom","yet another drop dead joint from the Madvillain","Deep Fried Frenz","Mmm..Food?");
    
    var question3 = new Verses("My grandma taught me courage <br> She told me never let the grizzly bears eat your porridge <br> Or you'll just be a carcass dying slowly in the forest <br> I could never thank her for it <br> But I can slay a devil when I see one <br> Steady practice mastery of self so not to be one <br> Life is like a re-run, season after season <br> Bombs on the train, bombs on the plane <br> Of disgruntled citizens being tried for treason",'answer3',"Jay Electronica","When is that album actually coming out?","Annikan's Prayer","Scratches & Demo Tape");
    ...
    */
    ...
    function compare(){
        if(selection == correct){
            ...
            $('#lyrics').append('<h4 id="feedback">'+ currentQ.phrase + '</h4>');
