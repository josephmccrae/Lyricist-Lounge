$(document).ready(function(){
    ...
    var question4 = new Verses("Only in America could you find a way to earn a healthy buck <br> And still keep your attitude on self-destruct",'answer1',"MF Doom","Yet another drop dead joint from the Madvillain","Operation: Doomsday");
