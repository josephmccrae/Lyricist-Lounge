$(document).ready(function(){
    ...
    function instructions(){
        $('.continue').click(function(){
            ...
            $('#sidebar').hide().delay(7000).fadeIn(5000);
        });
    }
    ...
    $('.apics').click(function(){
        $(this).removeClass('apics');
